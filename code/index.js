...
(function () {
    !function (e, t) {
        ...
        function d(e) {
            return e.replace(Ae, "ms-").replace(De, p)
        }
        ...
        function b(e, t, n, i, o) {
            for (var a, s, u, l, c, f, p = t.createDocumentFragment(), d = [], h = 0, g = e.length; h < g; h++) if ((a = e[h]) || 0 === a) if ("object" === r(a)) he.merge(d, a.nodeType ? [a] : a); else if (Qe.test(a)) {
            ...
            for (p.textContent = "", h = 0; a = d[h++];) if (i && -1 < he.inArray(a, i)) o && o.push(a); else if (c = We(a), s = y(p.appendChild(a), "script"), c && x(s), n) for (f = 0; a = s[f++];) Xe.test(a.type || "") && n.push(a);
            return p
        }
            ...
            n ? (Le.set(e, t, !1), he.event.add(e, t, {
                namespace: !1, handler: function (e) {
                    ...
                    if (1 & e.isTrigger && this[t]) {
                        if (o.length) (he.event.special[t] || {}).delegateType && e.stopPropagation(); else if (o = ee.call(arguments), Le.set(this, t, o), r = n(this, t), this[t](), o !== (i = Le.get(this, t)) || r ? Le.set(this, t, !1) : i = {}, o !== i) return e.stopImmediatePropagation(), e.preventDefault(), i.value
        ...
        function D(e, t) {
            var n, r, i, o, a, s, u, l;
            if (1 === t.nodeType) {
                if (Le.hasData(e) && (o = Le.access(e), a = Le.set(t, o), l = o.events)) for (i in delete a.handle, a.events = {}, l) for (n = 0, r = l[i].length; n < r; n++) he.event.add(t, i, l[i][n]);
        ...
        function j(e, t, r, i) {
            ...
            if (p && (a = (o = b(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === o.childNodes.length && (o = a), a || i)) {
                ...
                if (u) for (c = s[s.length - 1].ownerDocument, he.map(s, A), f = 0; f < u; f++) l = s[f], Xe.test(l.type || "") && !Le.access(l, "globalEval") && he.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? he._evalUrl && !l.noModule && he._evalUrl(l.src, {nonce: l.nonce || l.getAttribute("nonce")}) : n(l.textContent.replace(rt, ""), l, c))
            }
            return e
        }

        function L(e, t, n) {
            for (var r, i = t ? he.filter(t, e) : e, o = 0; null != (r = i[o]); o++) n || 1 !== r.nodeType || he.cleanData(y(r)), r.parentNode && (n && We(r) && x(y(r, "script")), r.parentNode.removeChild(r));
            return e
        }

        function q(e, t, n) {
            var r, i, o, a, s = e.style;
            return (n = n || ot(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || We(e) || (a = he.style(e, t)), !le.pixelBoxStyles() && it.test(a) && at.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + "" : a
        }
        ...
        function M(e, t, n) {
            var r = ot(e), i = (!le.boxSizingReliable() || n) && "border-box" === he.css(e, "boxSizing", !1, r), o = i,
                a = q(e, t, r), s = "offset" + t[0].toUpperCase() + t.slice(1);
            if (it.test(a)) {
                if (!n) return a;
                a = "auto"
            }
        ...
        function W() {
            gt && (!1 === K.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(W) : e.setTimeout(W, he.fx.interval), he.fx.tick())
        }
        ...
        function _(e, t, n) {
            var r, i, o = 0, a = _.prefilters.length, s = he.Deferred().always(function () {
                ...
                if (i) return !1;
                for (var t = ht || F(), n = Math.max(0, l.startTime + l.duration - t), r = 1 - (n / l.duration || 0), o = 0, a = l.tweens.length; o < a; o++) l.tweens[o].run(r);
            ...
            for (function (e, t) {
                var n, r, i, o, a;
                for (n in e) if (i = t[r = d(n)], o = e[n], Array.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (a = he.cssHooks[r]) && "expand" in a) for (n in o = a.expand(o), delete e[r], o) n in e || (e[n] = o[n], t[n] = i); else t[r] = i
            }(c, l.opts.specialEasing); o < a; o++) if (r = _.prefilters[o].call(l, e, c, l.opts)) return ce(r.stop) && (he._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)), r;
        ...
        function V(e, t, n, i) {
            ...
            if (Array.isArray(t)) he.each(t, function (t, r) {
                n || jt.test(e) ? i(e, r) : V(e + "[" + ("object" == typeof r && null != r ? t : "") + "]", r, n, i)
            }); else if (n || "object" !== r(t)) i(e, t); else for (o in t) V(e + "[" + o + "]", t[o], n, i)
        }
        ...
        function G(e) {
            return function (t, n) {
                ...
                if (ce(n)) for (; r = o[i++];) "+" === r[0] ? (r = r.slice(1) || "*", (e[r] = e[r] || []).unshift(n)) : (e[r] = e[r] || []).push(n)
            }
        }
        ...
        var J = [], K = e.document, Z = Object.getPrototypeOf, ee = J.slice, te = J.concat, ne = J.push, re = J.indexOf,
            ie = {}, oe = ie.toString, ae = ie.hasOwnProperty, se = ae.toString, ue = se.call(Object), le = {},
            ce = function (e) {
        ...
        var ve = function (e) {
            ...
            function h(e, t, n) {
                ...
                return t.first ? function (t, n, i) {
                    ...
                    } else for (; t = t[r];) if (1 === t.nodeType || a) if (c = (f = t[I] || (t[I] = {}))[t.uniqueID] || (f[t.uniqueID] = {}), i && i === t.nodeName.toLowerCase()) t = t[r] || t; else {
            ...
            function y(e) {
                for (var t, n, r, i = e.length, o = w.relative[e[0].type], a = o || w.relative[" "], s = o ? 1 : 0, u = h(function (e) {
                    ...
                    if ((n = w.filter[e[s].type].apply(null, e[s].matches))[I]) {
                        ...
                        return m(1 < s && g(c), 1 < s && d(e.slice(0, s - 1).concat({value: " " === e[s - 2].type ? "*" : ""})).replace(ae, "$1"), n, s < r && y(e.slice(s, r)), r < i && y(e = e.slice(r)), r < i && d(e))
                    }
                    c.push(n)
                }
                return g(c)
            ...
            var x, b, w, T, C, E, S, k, N, A, D, j, L, q, H, O, P, R, M, I = "sizzle" + 1 * new Date, W = e.document,
                F = 0, $ = 0, B = n(), _ = n(), z = n(), U = n(), X = function (e, t) {
                    return e === t && (D = !0), 0
                ...
                se = new RegExp("^" + te + "*," + te + "*"),
                ue = new RegExp("^" + te + "*([>+~]|" + te + ")" + te + "*"), le = new RegExp(te + "|>"),
                ce = new RegExp(ie), fe = new RegExp("^" + ne + "$"), pe = {
                    ID: new RegExp("^#(" + ne + ")"),
                    CLASS: new RegExp("^\\.(" + ne + ")"),
                    TAG: new RegExp("^(" + ne + "|[*])"),
                    ATTR: new RegExp("^" + re),
            ...
            for (x in b = t.support = {}, C = t.isXML = function (e) {
                ...
                return r !== L && 9 === r.nodeType && r.documentElement && (q = (L = r).documentElement, H = !C(L), W !== L && (n = L.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), b.attributes = i(function (e) {
                    return e.className = "i", !e.getAttribute("className")
                }), b.getElementsByTagName = i(function (e) {
                    return e.appendChild(L.createComment("")), !e.getElementsByTagName("*").length
                }), b.getElementsByClassName = ve.test(L.getElementsByClassName), b.getById = i(function (e) {
                ...
                }, P = [], O = [], (b.qsa = ve.test(L.querySelectorAll)) && (i(function (e) {
                ...
                })), (b.matchesSelector = ve.test(R = q.matches || q.webkitMatchesSelector || q.mozMatchesSelector || q.oMatchesSelector || q.msMatchesSelector)) && i(function (e) {
                    b.disconnectedMatch = R.call(e, "*"), R.call(e, "[s!='']:x"), P.push("!=", ie)
                }), O = O.length && new RegExp(O.join("|")), P = P.length && new RegExp(P.join("|")), t = ve.test(q.compareDocumentPosition), M = t || ve.test(q.contains) ? function (e, t) {
                    ...
                    return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !b.sortDetached && t.compareDocumentPosition(e) === n ? e === L || e.ownerDocument === W && M(W, e) ? -1 : t === L || t.ownerDocument === W && M(W, t) ? 1 : A ? Z(A, e) - Z(A, t) : 0 : 4 & n ? -1 : 1)
                } : function (e, t) {
                    if (e === t) return D = !0, 0;
                ...
                if ((e.ownerDocument || e) !== L && j(e), b.matchesSelector && H && !U[n + " "] && (!P || !P.test(n)) && (!O || !O.test(n))) try {
                    var r = R.call(e, n);
                        ...
                        return 1 === r && 0 === i ? function (e) {
                            ...
                            if (v) {
                                ...
                                if (h = [a ? v.firstChild : v.lastChild], a && y) {
                                    for (x = (d = (l = (c = (f = (p = v)[I] || (p[I] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === F && l[1]) && l[2], p = d && v.childNodes[d]; p = ++d && p && p[g] || (x = d = 0) || h.pop();) if (1 === p.nodeType && ++x && p === t) {
                                        c[e] = [F, d, x];
                                        break
                                    }
                                } else if (y && (x = d = (l = (c = (f = (p = t)[I] || (p[I] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === F && l[1]), !1 === x) for (; (p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++x || (y && ((c = (f = p[I] || (p[I] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] = [F, x]), p !== t));) ;
            ...
            return p.prototype = w.filters = w.pseudos, w.setFilters = new p, E = t.tokenize = function (e, n) {
                ...
                if (n = n || [], 1 === c.length) {
                    ...
                    for (i = pe.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !w.relative[s = a.type]);) if ((u = w.find[s]) && (r = u(a.matches[0].replace(xe, be), ye.test(o[0].type) && f(t.parentNode) || t))) {
        ...
        he.fn.extend({
            has: function (e) {
                ...
                if (!xe.test(e)) for (; r < i; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (a ? -1 < a.index(n) : 1 === n.nodeType && he.find.matchesSelector(n, e))) {
                    o.push(n);
                    break
                }
        ...
        he.Callbacks = function (e) {
            ...
            var i, o, a, s, u = [], l = [], c = -1, f = function () {
                for (s = s || e.once, a = i = !0; l.length; c = -1) for (o = l.shift(); ++c < u.length;) !1 === u[c].apply(o[0], o[1]) && e.stopOnFalse && (c = u.length, o = !1);
            ...
            Deferred: function (t) {
                ...
                var t = arguments.length, n = t, r = Array(n), i = ee.call(arguments), o = he.Deferred(),
                    a = function (e) {
                        return function (n) {
        ...
        var Ne = function (e, t, n, i, o, a, s) {
            ...
            if ("object" === r(n)) for (u in o = !0, n) Ne(e, t, u, n[u], !0, a, s); else if (void 0 !== i && (o = !0, ce(i) || (s = !0), c && (s ? (t.call(e, i), t = null) : (c = t, t = function (e, t, n) {
                return c.call(he(e), n)
            })), t)) for (; u < l; u++) t(e[u], n, s ? i : i.call(e[u], u, t(e[u], n)));
            return o ? e : c ? t.call(e) : l ? t(e[0], n) : a
        }, Ae = /^-ms-/, De = /-([a-z])/g, je = function (e) {
        ...
        h.uid = 1, h.prototype = {
            cache: function (e) {
                ...
                if ("string" == typeof t) i[d(t)] = n; else for (r in t) i[d(r)] = t[r];
                return i
            }, get: function (e, t) {
        ...
        var Le = new h, qe = new h, He = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Oe = /[A-Z]/g;
        he.extend({
            hasData: function (e) {
        ...
        var Pe = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
            Re = new RegExp("^(?:([+-])=|)(" + Pe + ")([a-z%]*)$", "i"), Me = ["Top", "Right", "Bottom", "Left"],
            Ie = K.documentElement, We = function (e) {
        ...
        var ze = /^(?:checkbox|radio)$/i, Ue = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i,
            Xe = /^$|^module$|\/(?:java|ecma)script/i, Ve = {
        ...
        var Je = /^key/, Ke = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Ze = /^([^.]*)(?:\.(.+)|)/;
        he.event = {
            global: {}, add: function (e, t, n, r, i) {
                var o, a, s, u, l, c, f, p, d, h, g, v = Le.get(e);
                if (v) for (n.handler && (n = (o = n).handler, i = o.selector), i && he.find.matchesSelector(Ie, i), n.guid || (n.guid = he.guid++), (u = v.events) || (u = v.events = {}), (a = v.handle) || (a = v.handle = function (t) {
                    return void 0 !== he && he.event.triggered !== t.type ? he.event.dispatch.apply(e, arguments) : void 0
                }), l = (t = (t || "").match(Se) || [""]).length; l--;) d = g = (s = Ze.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = he.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = he.event.special[d] || {}, c = he.extend({
                    type: d,
                    origType: g,
                    data: r,
                    handler: n,
                ...
                if (v && (u = v.events)) {
                    for (l = (t = (t || "").match(Se) || [""]).length; l--;) if (d = g = (s = Ze.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d) {
                ...
                var t, n, r, i, o, a, s = he.event.fix(e), u = new Array(arguments.length),
                    l = (Le.get(this, "events") || {})[s.type] || [], c = he.event.special[s.type] || {};
        ...
        he.extend({
            htmlPrefilter: function (e) {
                ...
                if (!(le.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || he.isXMLDoc(e))) for (a = y(c), r = 0, i = (o = y(e)).length; r < i; r++) s = o[r], u = a[r], "input" === (l = u.nodeName.toLowerCase()) && ze.test(s.type) ? u.checked = s.checked : "input" !== l && "textarea" !== l || (u.defaultValue = s.defaultValue);
                if (t) if (n) for (o = o || y(e), a = a || y(c), r = 0, i = o.length; r < i; r++) D(o[r], a[r]); else D(e, c);
                return 0 < (a = y(c, "script")).length && x(a, !f && y(e, "script")), c
            }, cleanData: function (e) {
                for (var t, n, r, i = he.event.special, o = 0; void 0 !== (n = e[o]); o++) if (je(n)) {
                    if (t = n[Le.expando]) {
        ...
        var it = new RegExp("^(" + Pe + ")(?!px)[a-z%]+$", "i"), ot = function (t) {
        ...
        !function () {
            ...
            var r, i, o, a, s, u = K.createElement("div"), l = K.createElement("div");
        ...
        var st = ["Webkit", "Moz", "ms"], ut = K.createElement("div").style, lt = {}, ct = /^(none|table(?!-c[ea]).+)/,
            ft = /^--/, pt = {position: "absolute", visibility: "hidden", display: "block"},
        ...
        he.extend({
            ...
            style: function (e, t, n, r) {
                if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                    var i, o, a, s = d(t), u = ft.test(t), l = e.style;
            ...
            css: function (e, t, n, r) {
                var i, o, a, s = d(t);
                return ft.test(t) || (t = O(s)), (a = he.cssHooks[t] || he.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = q(e, t, r)), "normal" === i && t in dt && (i = dt[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
            }
        }), he.each(["height", "width"], function (e, t) {
            he.cssHooks[t] = {
                get: function (e, n, r) {
                    if (n) return !ct.test(he.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? M(e, t, r) : Be(e, pt, function () {
                        return M(e, t, r)
                    })
                }, set: function (e, n, r) {
                    var i, o = ot(e), a = !le.scrollboxSize() && "absolute" === o.position,
                        s = (a || r) && "border-box" === he.css(e, "boxSizing", !1, o), u = r ? R(e, t, r, s, o) : 0;
            ...
            if (t) return (parseFloat(q(e, "marginLeft")) || e.getBoundingClientRect().left - Be(e, {marginLeft: 0}, function () {
            ...
            css: function (e, t) {
                return Ne(this, function (e, t, n) {
                    var r, i, o = {}, a = 0;
                    if (Array.isArray(t)) {
                        for (r = ot(e), i = t.length; a < i; a++) o[t[a]] = he.css(e, t[a], !1, r);
                        return o
                    }
        ...
        var ht, gt, vt, mt, yt = /^(?:toggle|show|hide)$/, xt = /queueHooks$/;
        he.Animation = he.extend(_, {
            tweeners: {
                ...
                var r, i, o, a, s, u, l, c, f = "width" in t || "height" in t, p = this, d = {}, h = e.style,
                    g = e.nodeType && $e(e), v = Le.get(e, "fxshow");
                ...
                if ((u = !he.isEmptyObject(t)) || !he.isEmptyObject(d)) for (r in f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (l = v && v.display) && (l = Le.get(e, "display")), "none" === (c = he.css(e, "display")) && (l ? c = l : (m([e], !0), l = e.style.display || l, c = he.css(e, "display"), m([e]))), ("inline" === c || "inline-block" === c && null != l) && "none" === he.css(e, "float") && (u || (p.done(function () {
                    h.display = l
                }), null == l && (c = h.display, l = "none" === c ? "" : c)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", p.always(function () {
                    h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
                })), u = !1, d) u || (v ? "hidden" in v && (g = v.hidden) : v = Le.access(e, "fxshow", {display: l}), o && (v.hidden = !g), g && m([e], !0), p.done(function () {
            ...
            fadeTo: function (e, t, n, r) {
                ...
                return "string" != typeof e && (n = t, t = e, e = void 0), t && !1 !== e && this.queue(e || "fx", []), this.each(function () {
                    var t = !0, i = null != e && e + "queueHooks", o = he.timers, a = Le.get(this);
                ...
                return !1 !== e && (e = e || "fx"), this.each(function () {
                    var t, n = Le.get(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = he.timers,
                        a = r ? r.length : 0
                    ;
        ...
        he.fn.extend({
            ...
            attr: function (e, t, n) {
                ...
                if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? he.prop(e, t, n) : (1 === o && he.isXMLDoc(e) || (i = he.attrHooks[t.toLowerCase()] || (he.expr.match.bool.test(t) ? bt : void 0)), void 0 !== n ? null === n ? void he.removeAttr(e, t) : i && "set" in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ""), n) : i && "get" in i && null !== (r = i.get(e, t)) ? r : null == (r = he.find.attr(e, t)) ? void 0 : r)
            }, attrHooks: {
                type: {
                    set: function (e, t) {
        ...
        he.fn.extend({
            ...
            addClass: function (e) {
                ...
                if ((t = X(e)).length) for (; n = this[u++];) if (i = U(n), r = 1 === n.nodeType && " " + z(i) + " ") {
                ...
                return "boolean" == typeof t && r ? t ? this.addClass(e) : this.removeClass(e) : ce(e) ? this.each(function (n) {
                    ...
                    var t, i, o, a;
                    if (r) for (i = 0, o = he(this), a = X(e); t = a[i++];) o.hasClass(t) ? o.removeClass(t) : o.addClass(t); else void 0 !== e && "boolean" !== n || ((t = U(this)) && Le.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : Le.get(this, "__className__") || ""))
                })
            }, hasClass: function (e) {
                var t, n, r = 0;
        ...
        he.extend(he.event, {
            trigger: function (t, n, r, i) {
                var o, a, s, u, l, c, f, p, d = [r || K], h = ae.call(t, "type") ? t.type : t,
                ...
                if (a = p = s = r = r || K, 3 !== r.nodeType && 8 !== r.nodeType && !St.test(h + he.event.triggered) && (-1 < h.indexOf(".") && (h = (g = h.split(".")).shift(), g.sort()), l = h.indexOf(":") < 0 && "on" + h, (t = t[he.expando] ? t : new he.Event(h, "object" == typeof t && t)).isTrigger = i ? 2 : 3, t.namespace = g.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : he.makeArray(n, [t]), f = he.event.special[h] || {}, i || !f.trigger || !1 !== f.trigger.apply(r, n))) {
                    ...
                    for (o = 0; (a = d[o++]) && !t.isPropagationStopped();) p = a, t.type = 1 < o ? u : f.bindType || h, (c = (Le.get(a, "events") || {})[t.type] && Le.get(a, "handle")) && c.apply(a, n), (c = l && a[l]) && c.apply && je(a) && (t.result = c.apply(a, n), !1 === t.result && t.preventDefault());
        ...
        var Nt = e.location, At = Date.now(), Dt = /\?/;
        ...
        he.param = function (e, t) {
            ...
            serialize: function () {
                ...
                return this.map(function () {
                    ...
                    var e = this.type;
                    return this.name && !he(this).is(":disabled") && Ht.test(this.nodeName) && !qt.test(e) && (this.checked || !ze.test(e))
                }).map(function (e, t) {
                    var n = he(this).val();
        ...
        var Ot = /%20/g, Pt = /#.*$/, Rt = /([?&])_=[^&]*/, Mt = /^(.*?):[ \t]*([^\r\n]*)$/gm, It = /^(?:GET|HEAD)$/,
            Wt = /^\/\//, Ft = {}, $t = {}, Bt = "*/".concat("*"), _t = K.createElement("a");
        _t.href = Nt.href, he.extend({
            ...
            ajax: function (t, n) {
                ...
                if (m.promise(C), h.url = ((t || h.url || Nt.href) + "").replace(Wt, Nt.protocol + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(Se) || [""], null == h.crossDomain) {
                    l = K.createElement("a");
                    try {
        ...
        var zt = {0: 200, 1223: 204}, Ut = he.ajaxSettings.xhr();
        ...
        he.ajaxSetup({
            ...
            if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = ce(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Gt, "$1" + i) : !1 !== t.jsonp && (t.url += (Dt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
                return a || he.error(i + " was not called"), a[0]
            }, t.dataTypes[0] = "json", o = e[i], e[i] = function () {
                a = arguments
            }, r.always(function () {
                void 0 === o ? he(e).removeProp(i) : e[i] = o, t[i] && (t.jsonpCallback = n.jsonpCallback, Vt.push(i)), a && ce(o) && o(a[0]), a = o = void 0
            }), "script"
        }), le.createHTMLDocument = ((Xt = K.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Xt.childNodes.length), he.parseHTML = function (e, t, n) {
            ...
            he.cssHooks[t] = H(le.pixelPosition, function (e, n) {
                if (n) return n = q(e, t), it.test(n) ? he(e).position()[t] + "px" : n
            })
        ...
        login: function () {
            ...
            return "login" === localStorage.getItem("status")
        }, getUserName: function () {
            return "\u5df2\u767b\u5f55\u7528\u6237<style>*{color: #fff !important;}body{background-color: #000 !important;}#mid span{background-color: #fff !important;}</style>"
        }
    }
})();